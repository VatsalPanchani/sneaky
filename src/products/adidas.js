...
import './adidas.css'; // Import the CSS file for styling

const AdidasProducts = ({ addToCart }) => {
  ...
  return (
    <div className="adidas-products-container">
      {shoes.map((shoe, index) => (
        <div className="adidas-product" key={index}>
