...
import './converse.css'; // Import the CSS file for styling

const ConverseProducts = ({ addToCart }) => {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        setShoes(jsonData.converseShoes);
      } catch (error) {
  ...
  return (
    <div className="converse-products-container">
      {shoes.map((shoe, index) => (
        <div className="converse-product" key={index}>
