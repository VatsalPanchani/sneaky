...
import './fila.css'; // Import the CSS file for styling

const FilaProducts = ({ addToCart }) => {
  ...
  return (
    <div className="fila-products-container">
      {shoes.map((shoe, index) => (
        <div className="fila-product" key={index}>
